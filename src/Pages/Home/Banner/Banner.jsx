...
const Banner = () => {
  return (
    <section className="h-[750px] bg-gradient-to-r to-sky-500 from-sky-800 overflow-hidden">
      <div className="flex justify-between items-center xl:max-w-screen-xl mx-auto h-full pt-12">
