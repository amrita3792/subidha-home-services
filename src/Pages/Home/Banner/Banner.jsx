...
const Banner = () => {
  return (
    <section className="lg:h-[750px] bg-gradient-to-r from-indigo-400 to-cyan-400 overflow-hidden">
      <div className="flex flex-col lg:flex-row justify-between items-center xl:max-w-screen-xl lg:max-w-screen-lg  mx-auto h-full pt-12 px-5">
        <div className="basis-7/12">
            ...
            <button className="border-2 text-white font-medium px-8 py-4 rounded-lg active:scale-95">More Information</button>
        </div>
