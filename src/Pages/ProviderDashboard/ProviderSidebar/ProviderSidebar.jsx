...
const ProviderSidebar = () => {
  ...
  const providerAccessLinks = [
    ...
    {
      id: 3,
      name: "Service Offer History",
      path: "/provider-dashboard/service-Offer-History",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
    ...
    //   id: 5,
    //   name: "Orders List",
    //   path: "/provider-dashboard/orders-list",
    //   icon: (
    //     <svg
    //       xmlns="http://www.w3.org/2000/svg"
    //       fill="none"
    ...
    },
    {
      id: 9,
      name: "Coupons",
      path: "/provider-dashboard/coupons",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
